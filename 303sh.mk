...
# audio UCM files
PRODUCT_COPY_FILES += $(LOCAL_PATH)/snd_soc_msm/snd_soc_msm_Taiko:system/etc/snd_soc_msm/snd_soc_msm_Taiko \
...
# Baseband assertion
#PRODUCT_PACKAGES += librecovery_updater_303sh
...
PRODUCT_PRIVATE_KEY := device/sharp/303sh/qcom.key
...
$(call inherit-product, vendor/sharp/303sh/303sh-vendor.mk)
